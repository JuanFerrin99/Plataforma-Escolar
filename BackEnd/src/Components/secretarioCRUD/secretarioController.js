...
module.exports.agregarSecretario = (req, res) => {
    const { nombre, apellido, dni, fechaNacimiento, telefono, mail, titulos, datosResidiencia, fechaIngreso, rol} = req.body;
