...
module.exports.agregarProfesor = (req, res) => {
    const { nombre, apellido, dni, fechaNacimiento, telefono, mail, titulos, datosResidencia, fechaIngreso, rol, cursos} = req.body;
...
module.exports.getProfesorMail = (req, res) => {
